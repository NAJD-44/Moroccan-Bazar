            ...
            <div class="card-body p-6">
              ...
              <form method="post">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input value="<?php echo $fnameValue ?>" type="text" id="fname" name="firstName" class="form-control form-control-lg" />
                </div>
                <div class="form-outline mb-4">
                    <label class="form-label" for="lname">Last Name:</label>
                  <input value="<?php echo $lnameValue ?>"  type="text" id="lname" name="lastName" class="form-control form-control-lg" />
                 </div>
                ...
                <div class="form-outline mb-4">
                   ...
                   <select name="city" class="form-select">
                    <option selected>Select your city</option>
                           <?php
                           include("city_MB.php");
                           $city=City::selectAllcities("Cities",$connect->conn);
                           foreach($city as $c){
